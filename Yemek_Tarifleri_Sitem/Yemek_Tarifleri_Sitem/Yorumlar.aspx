                ...
                <table class="auto-style6">
                    <tr>
                        <td class="auto-style8">
                            <asp:Label ID="Label1" runat="server" Text='<%# Eval("YorumAdSoyad") %>' CssClass="auto-style5"></asp:Label>
                        </td>
                        <td class="auto-style7">
                            <asp:Image ID="Image2" runat="server" Height="30px" ImageUrl="~/icons/delete.png" Width="30px" />
                        </td>
                        <td class="auto-style7">
                           <asp:Image ID="Image3" runat="server" Height="30px" ImageUrl="~/icons/updated.png" Width="30px" />
                        </td>
                    </tr>
                </table>
            </ItemTemplate>
    ...
    <asp:Panel ID="Panel3" runat="server">
        ...
        <table class="auto-style6">
            <tr>
                ...
                <td class="auto-style9">ONAYSIZ YORUM LİSTESİ</td>
            </tr>
        </table>
        <br />
        </strong></span></asp:Panel>
            ...
            <ItemTemplate>
                <table class="auto-style6">
                    <tr>
                        ...
                        <td class="auto-style7">
                           <a href="YorumDetay.aspx?Yorumid=<%# Eval("Yorumid") %>"><asp:Image ID="Image3" runat="server" Height="30px" ImageUrl="~/icons/updated.png" Width="30px" /></a>
                        </td>
                    </tr>
                </table>
            </ItemTemplate>
